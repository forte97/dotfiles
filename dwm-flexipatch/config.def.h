...
#include <X11/XF86keysym.h> /* include XF86 keys */
/* appearance */
...
static char *colors[][ColCount] = {
	...
	[SchemeTitleNorm]    = { normfgcolor,      normbgcolor,      normbordercolor,      normbordercolor },
	[SchemeTitleSel]     = { selfgcolor,       selbgcolor,       selbordercolor,       selbordercolor },
	[SchemeTagsNorm]     = { normfgcolor,      normbgcolor,      normbordercolor,      normbordercolor },
	[SchemeTagsSel]      = { selfgcolor,       selbgcolor,       selbordercolor,       selbordercolor },
...
static const char *volupdate[] = { "/usr/bin/aslstatus-update", "cmd:pamixer", NULL };
static const char *scrotcmd[] = { "/usr/bin/scrot", "-s", "Pictures/%Y-%m-%d-%H:%M:%S.png", NULL };
...
static Key keys[] = {
	...
	#else
	{ MODKEY|ShiftMask,                       XK_j,          focusstack,             {.i = +2 } },
	{ MODKEY|ShiftMask,                       XK_k,          focusstack,             {.i = -2 } },
	#endif // STACKER_PATCH
	#if FOCUSDIR_PATCH
